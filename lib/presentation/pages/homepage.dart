              ...
              child: Padding(
                ...
                child: const Column(
                  children: [
                    ...
                    SizedBox(height: 13,),
                    Text('Transform your home', style: TextStyle(fontSize: 17),),
                    Text('with our stunning', style: TextStyle(fontSize: 17),),
                    Text('furniture.', style: TextStyle(fontSize: 17),),
                  ],
                ),
              ),
            ),
                ...
                children: [
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: selectedFurniture == 'Sofa' ? Colors.transparent : buttonColor,
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: selectedFurniture == 'Kitchen Cabinet' ? Colors.transparent : buttonColor,
                      foregroundColor: const Color(0xffffffff),
                      side: const BorderSide(color: Color(0xFFD7B58D)),
                    ),
                    child: const Text('Kitchen Cabinet'),
                  ),
                  const SizedBox(width: 7,),
                  ElevatedButton(
                    onPressed: onDiningTableButtonPressed,
                    style: ElevatedButton.styleFrom(
                      backgroundColor: selectedFurniture == 'Dining Table' ? Colors.transparent: buttonColor,
                      foregroundColor: const Color(0xffffffff),
                      side: const BorderSide(color: Color(0xFFD7B58D)),
                    ),
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: selectedFurniture == 'Tv Stand' ? Colors.transparent : buttonColor,
                      foregroundColor: const Color(0xffffffff),
                      side: const BorderSide(color: Color(0xFFD7B58D)),
                    ),
                    child: const Text('Tv Stand'),
                  ),
                ],
              ),
            ),
